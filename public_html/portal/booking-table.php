<?php include('connect.php'); ?>
        ...
        <?php $query = ("SELECT a.*, b.*, c.* from booking as a, hotel as b, roomtype as c where a.hotelID = b.hotelID and a.typeID = c.typeID");
...
{ echo '
                               <tr>
                                    ...
                                    <td>'.$row["checkout"].'</td>
                                    <td> 
                                    <a href="manipulate.php?booking='.$row["bookingID"].'"> Edit </a>
                                    &nbsp;
                                    <a href="?remove_booking='.$row["bookingID"].'" onclick="return confirm(\'Are you sure you wish to proceed?\')"> Delete </a>
                                </td>
                               </tr>
                               ';
                          }?>
