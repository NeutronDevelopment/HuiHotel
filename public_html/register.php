    ...
    <div class="register-photo">
        <div class="form-container">
            ...
            <form method="post">
                ...
                <div class="form-group"><button name="reg_user" class="btn btn-primary btn-block" type="submit">Sign Up</button></div><a href="#" class="already">You already have an account? Login here.</a></form>
        </div>
    </div>
