...
<body>
    ...
    <div class="login-dark">
        <form method="post" >
            ...
            <div class="form-group"><button name="login_user" class="btn btn-primary btn-block" type="submit">Log In</button></div><a href="#" class="forgot">Forgot your email or password?</a>
        </form>
    </div>
