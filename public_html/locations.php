        ...
        <div class="container"><a class="navbar-brand" href="#">HUI Hotel</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav mr-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="locations.php">Locations</a></li>
    ...
    <div class="highlight-blue">
        <div class="container">
            <div class="intro">
                ...
                <p class="text-center">This page is not completed yet and will be released soon!</p>
            </div>
            <div class="buttons"><a class="btn btn-primary" role="button" href="index.php">Return</a></div>
        </div>
    </div>
